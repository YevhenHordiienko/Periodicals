...
namespace Periodicals
{
    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            // Enables the application to temporarily store user information when they are verifying the second
            // factor in the two-factor authentication process.
            ...
            // on the device where you logged in from.
